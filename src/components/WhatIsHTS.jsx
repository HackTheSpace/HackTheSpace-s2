...
const WhatIsHTS = () => {
  return (
    ...
    <div className='whatIs--image'>
        <div className='whatIs-image__1'>
            <Image src="/s1-image.jfif" alt='s1-images' width={442} height={650} />
        </div>
        <div className='whatIs-image__2'>
            <Image src="/s1-image.jfif" alt='s1-images' width={575} height={311} />
            <Image src="/s1-image.jfif" alt='s1-images' width={606} height={322} />
        </div>
    </div>
